...
import com.aconex.codechallenge.service.PhoneNumberToWordsServiceTest;
import com.aconex.codechallenge.utils.FileUtilityTest;

@RunWith(Suite.class)
@SuiteClasses({ PhoneNumberWordsAppTest.class,
    PhoneNumberToWordsServiceTest.class, FileUtilityTest.class, DictionaryServiceTest.class })
